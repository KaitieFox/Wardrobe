...
namespace WardrobeMVC.Controllers
{
    public class TopsController : Controller
    {
        ...
        {
            var tops = db.Tops.Include(t => t.ClothesType).Include(t => t.Color).Include(t => t.Occasion).Include(t => t.Season);
        ...
        public ActionResult Create([Bind(Include = "TopID,TopName,ColorID,SeasonID,OccasionID,TypeID,TopPhoto,TopNotes")] Top top)
        {
            ...
            ViewBag.TypeID = new SelectList(db.ClothesTypes, "TypeID", "TypeName", top.TypeID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,TopName,ColorID,SeasonID,OccasionID,TypeID,TopPhoto,TopNotes")] Top top)
        {
            if (ModelState.IsValid)
            {
